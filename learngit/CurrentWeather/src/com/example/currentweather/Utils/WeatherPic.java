...
public class WeatherPic {
	...
	public static Bitmap getPic(Context c, int RId, int type){
		Bitmap bmp = null;
		return bmp = BitmapFactory.decodeResource(c.getResources(), RId);
	}
	public static Bitmap getSmallPic(Context c, int index, int type){
		...
		//return Bitmap.createScaledBitmap(getPic(c, index, type), 40, 40, true);
	}
}
